package com.example.pl1.Adoptview.petdisplay;
...
import com.example.pl1.Adoptview.petdisplay.picker.ImageContract;
import com.example.pl1.Adoptview.petdisplay.picker.ImagePresenter;
import com.bumptech.glide.Glide;
import com.bumptech.glide.request.RequestOptions;
import com.example.pl1.BuildConfig;
...
public class petdisplay extends AppCompatActivity implements ImageContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_petdisplay);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_petdisplay, menu);
        return true;
    }
    ...
    public void displayImagePreview(String mFilePath) {
        Glide.with(petdisplay.this).load(mFilePath).apply(new RequestOptions().centerCrop().circleCrop().placeholder(R.drawable.profile_pic)).into(userProfilePhoto);
    }

    @Override
    public void displayImagePreview(Uri mFileUri) {
        Glide.with(petdisplay.this).load(mFileUri).apply(new RequestOptions().centerCrop().circleCrop().placeholder(R.drawable.profile_pic)).into(userProfilePhoto);
    }
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(petdisplay.this);
